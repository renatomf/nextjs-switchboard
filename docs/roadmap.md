...
| O túnel do Sentry (`tunnelRoute`, um rewrite do Next) repassa os cookies do navegador, e os ~9 KB do Clerk fazem o Sentry responder `400 Request Header Or Cookie Too Large`: nenhum evento do navegador chega ao Sentry | `next.config.ts` | 🟠 | Rota própria de túnel que repassa só o envelope |
