...
| Um modelo sobrecarregado segura o passo por minutos: o Agent com o `gemini-3.5-flash` falhou depois de 3 tentativas e 209 s ("This model is currently experiencing high demand"), perto do limite de 5 minutos da sessão da Browserbase | `run-workflow.ts` | 🟡 | C.3: timeout por passo, com as tentativas cabendo na sessão |
